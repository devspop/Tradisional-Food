        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
                ...
                <li class="no-padding">
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Message</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-tickets.php">All Massage</a>
                                </li>
								<?php
...
<div id="work-collections" class="seaction">
                            ...
                            <span>Rp. '.$row1['price'].'00</span>
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>Rp. '.$row['total'].'00</strong></span>
                                            </div>';										
								if(!$deleted){
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
       <div class="container">
        <span>Copyright © 2017 <a class="grey-text text-lighten-4" href="#" target="_blank"></a> </span>@Devs</a></span>
        </div>
  </footer>
    <!-- END FOOTER -->
